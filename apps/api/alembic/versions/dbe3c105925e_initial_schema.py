...
def upgrade() -> None:
    ...
    sa.Column('slug', sa.String(length=120), nullable=False),
    sa.Column('name', sa.String(length=200), nullable=False),
    sa.Column('category', sa.Enum('concept', 'company', 'format', 'skill', 'formula', name='tag_category'), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('difficulty', sa.Enum('easy', 'medium', 'hard', 'expert', name='difficulty'), nullable=True),
    sa.ForeignKeyConstraint(['topic_id'], ['topics.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('status', sa.Enum('draft', 'approved', 'rejected', name='content_status'), nullable=False),
    ...
    sa.Column('relationship_type', sa.Enum('requires', 'related_to', 'used_in', name='concept_edge_relationship_type'), nullable=False),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('source_concept_id', 'target_concept_id', 'relationship_type', name='uq_concept_edges_source_target_relationship')
    )
    op.create_index(op.f('ix_concept_edges_relationship_type'), 'concept_edges', ['relationship_type'], unique=False)
    op.create_index(op.f('ix_concept_edges_source_concept_id'), 'concept_edges', ['source_concept_id'], unique=False)
    op.create_index(op.f('ix_concept_edges_target_concept_id'), 'concept_edges', ['target_concept_id'], unique=False)
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('learning_path_id', 'order_index', name='uq_learning_path_steps_path_order')
    )
    op.create_index(op.f('ix_learning_path_steps_concept_id'), 'learning_path_steps', ['concept_id'], unique=False)
    op.create_index(op.f('ix_learning_path_steps_learning_path_id'), 'learning_path_steps', ['learning_path_id'], unique=False)
