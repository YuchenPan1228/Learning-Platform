...
MATHEMATICS_QUESTIONS: tuple[QuestionSeed, ...] = (
    ...
    QuestionSeed(
        ...
        body=("Let A = [[1, 2], [3, 4]]. What is A[1, 0]^T? Enter the result as (a,b)."),
        topic_slug="mathematics",
        subtopic_slug="vectors-matrices",
        difficulty=Difficulty.EASY,
        short_answer="(1,3)",
        canonical_solution=("A e₁ equals the first column of A, so A[1,0]^T = [1,3]^T."),
    ...
    QuestionSeed(
        ...
        body=("Let u = [1, 2]^T and v = [3, 4]^T. What is the (2,1) entry of uv^T?"),
        topic_slug="mathematics",
        subtopic_slug="vectors-matrices",
        difficulty=Difficulty.EASY,
        short_answer="6",
        canonical_solution=("uv^T = [[3,4],[6,8]]. The (2,1) entry is u₂ v₁ = 2·3 = 6."),
    ...
    QuestionSeed(
        ...
        body=("In R^3, what is [1,0,0]^T × [0,1,0]^T? Enter as (a,b,c)."),
        topic_slug="mathematics",
        subtopic_slug="vectors-matrices",
        difficulty=Difficulty.EASY,
        short_answer="(0,0,1)",
        canonical_solution=("i × j = k, so [1,0,0]^T × [0,1,0]^T = [0,0,1]^T."),
        estimated_time_seconds=120,
    ...
    QuestionSeed(
        ...
        body=("A is a 3×5 matrix with rank 2. What is dim N(A)?"),
        topic_slug="mathematics",
        subtopic_slug="linear-systems",
    ...
    QuestionSeed(
        ...
        body=("What are the eigenvalues of diag(2, 5)? Enter them in increasing order as a,b."),
        topic_slug="mathematics",
    ...
    QuestionSeed(
        ...
        body=(
            "Find the eigenvalues of A = [[2, 1], [1, 2]]. Enter them in increasing order as a,b."
        ),
        topic_slug="mathematics",
        subtopic_slug="eigenvalues",
        difficulty=Difficulty.MEDIUM,
    ...
    QuestionSeed(
        ...
        body=("Is A = [[2, 1], [1, 2]] symmetric positive definite? Answer yes or no."),
        topic_slug="mathematics",
        subtopic_slug="eigenvalues",
        difficulty=Difficulty.MEDIUM,
        short_answer="yes",
    ...
    QuestionSeed(
        ...
        body=("Project b = [2, 2]^T onto span{[1, 0]^T}. Enter the projection as (a,b)."),
        topic_slug="mathematics",
        subtopic_slug="orthogonality",
        difficulty=Difficulty.EASY,
        short_answer="(2,0)",
        canonical_solution=("Onto unit vector u=[1,0]^T: proj = (u^T b)u = 2[1,0]^T = [2,0]^T."),
        estimated_time_seconds=120,
    ...
    QuestionSeed(
        ...
        body=("Are u = [3, 4]^T and v = [−4, 3]^T orthogonal? Answer yes or no."),
        topic_slug="mathematics",
        subtopic_slug="orthogonality",
        difficulty=Difficulty.EASY,
        short_answer="yes",
    ...
    QuestionSeed(
        ...
        body=("Let f(x,y) = x^2 y + e^y. What is ∇f at (1, 0)? Enter as (a,b)."),
        topic_slug="mathematics",
        subtopic_slug="derivatives-gradients",
        difficulty=Difficulty.MEDIUM,
        short_answer="(0,2)",
        canonical_solution=("∇f = (2xy, x^2 + e^y). At (1,0): (0, 1+1) = (0,2)."),
        estimated_time_seconds=180,
    ...
    QuestionSeed(
        ...
        difficulty=Difficulty.MEDIUM,
        short_answer="pi",
        canonical_solution=("f' = 2x sin x + x^2 cos x. At x=π/2: 2·(π/2)·1 + (π/2)^2·0 = π."),
    ...
    QuestionSeed(
        ...
        body=("Where is the critical point of f(x,y) = x^2 + y^2? Enter as (a,b)."),
        topic_slug="mathematics",
        subtopic_slug="derivatives-gradients",
        difficulty=Difficulty.EASY,
        short_answer="(0,0)",
    ...
    QuestionSeed(
        ...
        body=("Using e^h ≈ 1 + h + (1/2)h^2, approximate e^{0.1}. Enter a decimal."),
        topic_slug="mathematics",
    ...
    QuestionSeed(
        ...
        body=("Using log(1+r) ≈ r − (1/2)r^2, approximate log(1.01). Enter a decimal."),
        topic_slug="mathematics",
        subtopic_slug="taylor-expansions",
        difficulty=Difficulty.MEDIUM,
    ...
    QuestionSeed(
        ...
        body=("Minimize f(x) = x^2 − 4x + 1 over the reals. What is the minimizer x*?"),
        topic_slug="mathematics",
    ...
    QuestionSeed(
        ...
        body=("Maximize f(x,y) = xy subject to x + y = 1. What is the maximum value?"),
        topic_slug="mathematics",
        subtopic_slug="lagrange-multipliers",
        difficulty=Difficulty.MEDIUM,
        short_answer="1/4",
        canonical_solution=("∇f = λ∇g with g=x+y−1: (y,x)=λ(1,1) and x+y=1 ⇒ x=y=1/2 ⇒ f=1/4."),
        estimated_time_seconds=300,
    ...
    QuestionSeed(
        ...
        body=("Minimize x^2 + y^2 subject to x + 2y = 1. What is x* at the minimum?"),
        topic_slug="mathematics",
        subtopic_slug="lagrange-multipliers",
        difficulty=Difficulty.MEDIUM,
        short_answer="1/5",
    ...
    QuestionSeed(
        ...
        body=("Solve y' = −3y with y(0) = 5. The solution is y(t) = C e^{-3t}. What is C?"),
        topic_slug="mathematics",
